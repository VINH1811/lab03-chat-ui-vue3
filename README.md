...
| **Ảnh minh chứng** | *(Sinh viên tiến hành chụp ảnh toàn bộ màn hình giao diện chat thực tế đang chạy mượt mà, có tin nhắn người dùng, tin nhắn bot phản hồi và dán ảnh vào vị trí này để hoàn thành tài liệu)* |
